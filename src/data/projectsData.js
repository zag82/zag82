...
export const projectsEn = [
  {
    ...
    src: '/assets/apps/gsmeta.7z',
    img: '/assets/projects/gsmeta.png',
    extra: {
      title: 'Links',
      name: 'Project site',
      link: 'https://gsmeta.zag82.ru/'
    }
  },
  {
    name: 'QNotes',
    ...
    src: '/assets/apps/qnotes.7z',
    img: '/assets/projects/qnotes.png'
  },
  {
    name: 'Gosstroysmeta',
...

  {
    ...
    overview: `
      Programm allows you to connect to Rohman PL500 eddy current testing device 
    ...
    src: '/assets/apps/Ariel.7z',
    img: '/assets/projects/ariel.png'
  },
  {
    name: 'MagNum3D',
    ...
    src: '/assets/apps/MagNum3D.7z',
    img: '/assets/projects/magnum3d.png'
  }
];
